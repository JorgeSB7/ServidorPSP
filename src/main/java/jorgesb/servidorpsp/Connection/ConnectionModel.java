...
public class ConnectionModel {
    ...
    public ConnectionModel(String host, String db, String user, String password) {
        this.host = host;
        this.db = db;
        this.user = user;
    ...
    public void setPassword(String password) {
     ...
     public void loadDataXML() {
        ...
        if (f.canRead()) {
            JAXBContext context;
            try {
                context = JAXBContext.newInstance(ConnectionModel.class);
                Unmarshaller um = context.createUnmarshaller();
                ConnectionModel miconextion = (ConnectionModel) um.unmarshal(f);
